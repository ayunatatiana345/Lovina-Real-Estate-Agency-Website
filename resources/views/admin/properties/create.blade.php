...
<form action="{{ route('admin.properties.store') }}" method="POST" enctype="multipart/form-data" id="property-form">
    ...
    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 24px; flex-wrap: wrap; gap: 16px;">
        <div>
            ...
            <p style="font-size: 14px; color: #64748B;">Create a new property listing with details, specifications, and gallery.</p>
        </div>
    ...
    <div class="property-tab-content" id="property-tab-general" style="display: block;">
        <div class="admin-card" style="padding: 28px;">
            ...
            <div class="form-group" style="margin-bottom: 20px;">
                ...
                <input type="text" name="name" id="name" class="form-control" placeholder="e.g. Azure Vista Oceanfront Residence" value="{{ old('name') }}" style="width: 100%;" required>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 24px; margin-bottom: 20px;">
                <div class="form-group" style="margin-bottom: 0;">
                    ...
                    <input type="number" step="0.01" name="price" id="price" class="form-control" placeholder="450000" value="{{ old('price') }}" style="width: 100%;" required>
                </div>
            ...
            <div class="form-group" style="margin-bottom: 0;">
                ...
                <textarea name="description" id="description" class="form-control editor-textarea" style="min-height: 180px; width: 100%; resize: vertical; border-top: none;" placeholder="Full overview of the property...">{{ old('description') }}</textarea>
            </div>
        </div>
    </div>
        ...
        <div class="admin-card" style="padding: 28px;">
            ...
            <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 24px; margin-bottom: 20px;">
                <div class="form-group" style="margin-bottom: 0;">
                    ...
                    <input type="number" name="bedrooms" id="bedrooms" class="form-control" value="{{ old('bedrooms', 3) }}" style="width: 100%;" required>
                </div>

                <div class="form-group" style="margin-bottom: 0;">
                    <label class="form-label" for="bathrooms">Bathrooms</label>
                    <input type="number" name="bathrooms" id="bathrooms" class="form-control" value="{{ old('bathrooms', 2) }}" style="width: 100%;" required>
                </div>

                <div class="form-group" style="margin-bottom: 0;">
                    <label class="form-label" for="land_size">Land Size (m²)</label>
                    <input type="number" name="land_size" id="land_size" class="form-control" value="{{ old('land_size', 400) }}" style="width: 100%;" required>
                </div>

                <div class="form-group" style="margin-bottom: 0;">
                    <label class="form-label" for="building_size">Building Size (m²)</label>
                    <input type="number" name="building_size" id="building_size" class="form-control" value="{{ old('building_size', 250) }}" style="width: 100%;" required>
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 24px; margin-bottom: 24px;">
                <div class="form-group" style="margin-bottom: 0;">
                    ...
                    <input type="number" name="garage" id="garage" class="form-control" value="{{ old('garage', 2) }}" style="width: 100%;" required>
                </div>

                <div class="form-group" style="margin-bottom: 0;">
                    <label class="form-label" for="electricity">Electricity (VA)</label>
                    <input type="text" name="electricity" id="electricity" class="form-control" value="{{ old('electricity', '5500 VA') }}" style="width: 100%;">
                </div>

                <div class="form-group" style="margin-bottom: 0;">
                    <label class="form-label" for="water_supply">Water Supply</label>
                    <input type="text" name="water_supply" id="water_supply" class="form-control" value="{{ old('water_supply', 'PDAM') }}" style="width: 100%;">
                </div>
            </div>
    ...
    <div class="property-tab-content" id="property-tab-gallery" style="display: none;">
        <div class="admin-card" style="padding: 28px;">
            ...
            <div class="gallery-grid" id="gallery-preview-grid">
                <!-- Dynamically populated via local JS File Reader -->
            </div>
        </div>
    </div>
    ...
    <div style="display: flex; gap: 12px; justify-content: flex-end; margin-top: 24px;">
        ...
        <button type="submit" class="btn btn-primary" style="padding: 12px 32px; background-color: #1E3A8A; border-color: #1E3A8A;">Save & Publish Property</button>
    </div>
</form>
@endsection
